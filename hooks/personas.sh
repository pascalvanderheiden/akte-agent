...
persona_is_available() {
  case "$1" in
    clinician-visit-prep|finance-close|hr-onboarding|insurance|it-service-desk|plant-floor-supervisor|retail-banking|sales-account-review|wealth-management)
      return 1 ;;
    *) return 0 ;;
  esac
}
